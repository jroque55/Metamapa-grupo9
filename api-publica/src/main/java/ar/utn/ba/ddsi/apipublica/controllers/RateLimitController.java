...
import ar.utn.ba.ddsi.apipublica.config.RateLimitingFilter;
...
public class RateLimitController {
    ...
    private final RateLimitingFilter rateLimitConfig;

    @Autowired
    public RateLimitController(RateLimitingFilter rateLimitConfig) {
